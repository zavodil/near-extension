...
export class Social {
  ...
  async likesNumber(accountId, path, blockHeight) {/*
    return (
        Object.keys(
            (await this.get(`${accountId}/graph/like/${accountId}/post/comment/${blockHeight}`)) || {}
        )
    );*/
    ...
    console.log("likesNumber", item)

    return (await this.index("like", item, {})) || [];
  }
